...
(function(e) {
    e.fn.columns = function(n) {
        ...
        }) : this.each(function() { e.data(this, "columns") || e.data(this, "columns", new t(this, n)) });
    ...
    var t = function(t, n) {
        ...
        this.create = function() {
            ...
            function r(n, r) {
                ...
                e.each(t.schema, function(e, n) { n.hide || (n.template ? i.push("<td>" + t.chevron(n.template, r) + "</td>") : i.push("<td>" + r[n.key] + "</td>")) });
                i.push("</tr>");
                return i
            }
            ...
            s();
            i();
            var o = { prevPage: t.page - 1, nextPage: t.page + 1, prevPageExists: t.pageExists(t.page - 1), nextPageExists: t.pageExists(t.page + 1), resultRange: t.range, tableTotal: t.total, showRowsMenu: t.showRowsMenu, rows: t.rows, headers: t.thead, query: t.query, search: t.search, table: t.table };
            e.extend(t.view, o);
            t.plugins && e.each(t.plugins, function(e, n) { typeof ColumnsPlugins != "undefined" && typeof ColumnsPlugins[n] != "undefined" && ColumnsPlugins[n].create.call(t) });
            if (t.search) {
        ...
        this.init = function() {
            function n() {
                t.schema = [];
                e.each(t.data[0], function(e) { t.schema.push({ header: e, key: e }) })
            }

            function r() {
                t.searchableFields = [];
                e.each(t.data[0], function(e) { t.searchableFields.push(e) })
            }

            function i() {
                t.sortableFields = [];
                e.each(t.data[0], function(e) { t.sortableFields.push(e) })
            }

            function s() { e.ajax({ url: t.templateFile, async: !1, success: function(e) { t.template = e }, error: function() { e.error("Template could not be found.") } }) }
            var t = this;
            if (e.isArray(t.data)) {
                t.master = [];
                t.view = {};
                ...
                t.plugins && e.each(t.plugins, function(e, n) { typeof ColumnsPlugins != "undefined" && typeof ColumnsPlugins[n] != "undefined" && ColumnsPlugins[n].init.call(t) });
    ...
    t.prototype = {
        ...
        getTimer: function() { console.log((this.endTime - this.startTime) / 1e3) }
    }
})(jQuery);
(function(e, t) { e.Mustache = t({}) })(this, function(e) {
    function r(e) {
    ...
    E.prototype.clearCache = function() { this.cache = {} };
